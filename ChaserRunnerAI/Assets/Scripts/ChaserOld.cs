...
public class ChaserOld : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        {
            desiredDirection = new Vector3(continuousActions[0], 0f, continuousActions[1]);
        }
        else
        {
            desiredDirection = Vector3.zero;
        ...
        directiontext2.text = $"Diff: {distanceDifference.ToString()}";
